About pandas_ml-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pandas_ml-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/pandas-ml/pandas-ml

Documentation: http://pandas-ml.readthedocs.org/en/stable
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=750&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pandas_ml-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pandas_ml` can be installed with `conda`:
...
```
mamba install pandas_ml
```

It is possible to list all of the versions of `pandas_ml` available on your platform with `conda`:
...
```
mamba search pandas_ml --channel conda-forge
```
...
mamba repoquery search pandas_ml --channel conda-forge

# List packages depending on `pandas_ml`:
mamba repoquery whoneeds pandas_ml --channel conda-forge

# List dependencies of `pandas_ml`:
mamba repoquery depends pandas_ml --channel conda-forge
```
